...
<div class="flex flex-col gap-[48px]">
    ...
    <nav class="bg-[#05668D] shadow-[4px_6px_3px_0px_rgba(0,_0,_0,_0.2)] flex items-center gap-60 h-20 px-5 rounded-b-[80px] biggerNav smallScreenGap">
        ...
        <div class="flex-2 flex px-5 gap-4 smallScreenGap">
            <a class="text-base font-semibold text-center btn w-60 shadow-[4px_6px_3px_0px_rgba(0,_0,_0,_0.2)] navButtonsSmall btn p-4"" href="#" onclick="scrollToSection('target-group-and-context')">Doelgroep en context</a>
            <a class="text-base font-semibold text-center btn w-60 shadow-[4px_6px_3px_0px_rgba(0,_0,_0,_0.2)] navButtonsSmall btn p-4"" href="#" onclick="scrollToSection('type-sensor')">Type sensor</a>
            <a class="text-base font-semibold text-center btn w-60 shadow-[4px_6px_3px_0px_rgba(0,_0,_0,_0.2)] navButtonsSmall btn p-4"" href="#" onclick="scrollToSection('how-does-it-work')">Hoe werkt het?</a>
        </div>
    </nav>
