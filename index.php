...
<div class="flex flex-col gap-[48px]">
    ...
    <nav class="bg-[#05668D] items-center h-16 flex px-5 rounded-b-[80px]">
        <div class="flex-3">
            <img src="" alt="logo"/>
        </div>
    ...
    <div class="mx-12 smallSideMargin">
        <header class="bg-[#05668D] rounded-[40px] p-10 mx-5">
    ...
    <section id="target-group-and-context" class="flex flex-row rowToColumn gap-2">
        <div class="flex flex-col border-4 border-[#BDE692] flex-1 m-5 noSideMargin rounded-[40px] p-5 items-center relative">
            ...
            <p class="mt-10 text-center align-middle text-lg">
                ...
                We hebben dit product gemaakt voor mensen met een motorische beperking (voornamelijk rolstoelgebruikers)
                en proberen winkelen voor deze groep te verbeteren.
                Uit ons onderzoek is gebleken dat veel rolstoelgebruikers moeite hebben met hoge schappen te bereiken.
                Daarom moeten ze vaak om hulp vragen van medewerkers.
...
<main class="my-12 text-black ">
    ...
    <section id="type-sensor" class="flex flex-row rowToColumn gap-2">
        <div class="flex flex-col border-4 border-[#BDE692]  flex-1 m-5 noSideMargin rounded-[40px] p-3 gap-2 relative">
            <h2 class="bg-[#05668D] rounded-b-[80px] rounded-t-[50px] h-14 text-white w-[101%] absolute -top-1 left-0 text-center pt-3 text-2xl">Type sensor</h2>
            ...
            <button class="btn p-5 m-2" onclick="changeImage('images/shake.webp'); changeText('Je activeert de Handycaller door te schudden. Deze stuurt vervolgens een signaal naar een medewerker waarin staat dat je hulp nodig hebt in een bepaalde aisle.')">Schudden</button>
            <button class="btn p-5 m-2" onclick="changeImage('images/hover.jpg'); changeText('Als je met de zender hovert over de ontvanger krijgt die met infrarood een bericht binnen.')">Hover</button>
            <button class="btn p-5 m-2" onclick="changeImage('images/press-button.jpg'); changeText('Met de knoppen op de CPX kunt u het aisle nummer veranderen zodat de medewerker je locatie weet. Dit nummer is ook gevisualiseerd met lampjes.')">Druk knop</button>
        <div class="flex flex-col border-8 border-[#BDE692] shadow-[4px_6px_3px_0px_rgba(0,_0,_0,_0.2)] flex-1 m-5 noSideMargin rounded-[40px] p-3 gap-2">
            ...
            <p>Bij de ontwikkeling van ons product hebben we meerdere typen sensoren geprobeerd en getest. Deze sensoren kunt u in werking zien in de afbeelding hiernaast. Door op de knoppen te klikken kunt u een foto zien van hoe dat eruitziet.</p>
